...
gsap.set('.team-member', { xPercent: 400, opacity: 0, scale: 0 });

const spacing = 0.1, 
    snapTime = gsap.utils.snap(spacing), 
    teamMembers = gsap.utils.toArray('.team-grid .team-member'),
    animateFunc = element => {
    ...
    seamlessLoop = buildSeamlessLoop(teamMembers, spacing, animateFunc),
    playhead = { offset: 0 }, 
